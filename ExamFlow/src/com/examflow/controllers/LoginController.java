...
import com.examflow.dao.EtudiantDao;
...
public class LoginController {
	public static Etudiant sessionEtudiant;
	...
	public void handleLogin() throws IOException {
		...
		sessionEtudiant = EtudiantDao.authEtudiant(email, mdp);
	...
	public void adjustLayout() {
		Font kanitFont = Font.loadFont(getClass().getResourceAsStream("/com/examflow/resources/fonts/Kanit-Regular.ttf"), 20);
